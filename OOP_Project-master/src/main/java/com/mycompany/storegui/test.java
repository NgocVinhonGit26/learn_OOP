...
//	}
	 ...
	 * Create the frame.
	 */
	public test(String productName, String imageAddress, Double cost, String quantity) {
        ...
        dmm.getContentPane().add(panel1);
                        ...
                        temJLabel = new JLabel(productName, new ImageIcon(ImageIO.read(url)),
                                JLabel.CENTER);
